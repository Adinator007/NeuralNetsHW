...
## Set Seeds
torch.backends.cudnn.benchmark = True # cudnn benchmark olja, hogy a bemeneti adataidhoz mi a legjobb algoritmus, akkor hasznaldd, ha azonos a bemeneti meret mindig
random.seed(1234)
np.random.seed(1234)
